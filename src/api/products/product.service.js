...
// CREATE PRODUCT
export const createProduct = async (productData, shopId, organizationId, userId) => {
...
export const calculateProductPrice = async (productData, metalRates) => {
...
// GET ALL PRODUCTS
export const getProducts = async (shopId, organizationId, filters = {}, options = {}) => {
  const {
    page = 1,
    limit = 20,
    sort = '-createdAt',
...
// GET PRODUCT BY ID
export const getProductById = async (productId, shopId, organizationId) => {
  // Check cache first
...
// UPDATE PRODUCT
export const updateProduct = async (productId, shopId, organizationId, updateData, userId) => {
  const product = await Product.findOne({
    _id: productId,
    shopId,
    organizationId,
...
export const deleteProduct = async (productId, shopId, organizationId, userId) => {
  const product = await Product.findOne({
    _id: productId,
    shopId,
    organizationId,
...
// UPDATE STOCK
export const updateStock = async (productId, shopId, organizationId, stockData, userId) => {
...
// CANCEL RESERVATION
export const cancelReservation = async (productId, shopId, organizationId, userId) => {
  const product = await Product.findOne({
    _id: productId,
    shopId,
    organizationId,
...
// MARK AS SOLD
export const markAsSold = async (productId, shopId, organizationId, saleData, userId) => {
...
export const recalculatePrice = async (productId, shopId, organizationId, priceData, userId) => {
...
export const getLowStockProducts = async (shopId, organizationId, threshold) => {
  const query = {
    shopId,
    organizationId,
    deletedAt: null,
...
export const searchProducts = async (shopId, organizationId, searchQuery, limit = 10) => {
  const query = {
    shopId,
    organizationId,
    deletedAt: null,
...
// GET PRODUCT HISTORY
export const getProductHistory = async (productId, shopId, organizationId, limit = 50) => {
  const product = await Product.findOne({
    _id: productId,
    shopId,
    organizationId,
...
export const bulkDeleteProducts = async (productIds, shopId, organizationId, userId) => {
...
// BULK UPDATE STATUS
export const bulkUpdateStatus = async (productIds, shopId, organizationId, status, userId) => {
