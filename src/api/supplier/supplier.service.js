 ...
 */
export async function createSupplier(supplierData, userId, organizationId, shopId) {
  try {
 ...
 */
export async function getSuppliers(shopId, organizationId, filters = {}, pagination = {}) {
  try {
    const {
      page = 1,
      limit = 20,
 ...
 * Get supplier by ID
 */
export async function getSupplierById(supplierId, shopId, organizationId) {
  try {
 ...
 * Update supplier
 */
export async function updateSupplier(supplierId, updateData, userId, shopId, organizationId) {
  try {
    const supplier = await Supplier.findOne({
      _id: supplierId,
      shopId,
 ...
 */
export async function deleteSupplier(supplierId, userId, shopId, organizationId) {
  try {
    const supplier = await Supplier.findOne({
      _id: supplierId,
      shopId,
 ...
 */
export async function restoreSupplier(supplierId, userId, shopId, organizationId) {
  try {
    const supplier = await Supplier.findOne({
      _id: supplierId,
      shopId,
 ...
 */
export async function updateRating(supplierId, ratings, userId, shopId, organizationId) {
  try {
    const supplier = await Supplier.findOne({
      _id: supplierId,
      shopId,
 ...
 * Blacklist supplier
 */
export async function blacklistSupplier(supplierId, reason, userId, shopId, organizationId) {
  try {
    const supplier = await Supplier.findOne({
      _id: supplierId,
      shopId,
 ...
 */
export async function removeBlacklist(supplierId, userId, shopId, organizationId) {
  try {
    const supplier = await Supplier.findOne({
      _id: supplierId,
      shopId,
 ...
 */
export async function markAsPreferred(supplierId, userId, shopId, organizationId) {
  try {
    const supplier = await Supplier.findOne({
      _id: supplierId,
      shopId,
 ...
 */
export async function removePreferred(supplierId, userId, shopId, organizationId) {
  try {
    const supplier = await Supplier.findOne({
      _id: supplierId,
      shopId,
 ...
 */
export async function updateBalance(supplierId, amount, type, note, userId, shopId, organizationId) {
  try {
    const supplier = await Supplier.findOne({
      _id: supplierId,
      shopId,
 ...
 */
export async function getSupplierStats(shopId, organizationId) {
  try {
 ...
 */
export async function getTopSuppliers(shopId, organizationId, limit = 10) {
  try {
