...
// Metal Rate Management - Business Logic Layer (Functional Implementation)
 ...
 */
const updateShopSettings = async (shop, metalRate) => {
  try {
 ...
 */
const invalidateCaches = async shopId => {
  try {
    await Promise.all([
...
export const createOrUpdateTodayRate = catchAsync(async (shopId, rateData, userId) => {
...
export const getCurrentRate = catchAsync(async shopId => {
  // 1. Try cache first
...
export const getRateHistory = catchAsync(async (shopId, filters = {}) => {
...
export const getRateByDate = catchAsync(async (shopId, date) => {
  // Normalize date
...
export const compareRates = catchAsync(async (shopId, fromDate, toDate) => {
...
export const getTrendChartData = catchAsync(async (shopId, metalType = 'gold', days = 90) => {
  // Validate metalType
...
export const syncToAllShops = catchAsync(async (organizationId, rateData, userId) => {
...
export const getOrganizationRate = catchAsync(async organizationId => {
...
// DEACTIVATE RATE
export const deactivateRate = catchAsync(async (rateId, userId) => {
...
// SOFT DELETE RATE
export const deleteRate = catchAsync(async (rateId, userId) => {
  const rate = await MetalRate.findById(rateId);
